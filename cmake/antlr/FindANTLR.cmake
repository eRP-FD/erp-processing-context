...
#    https://github.com/antlr/antlr4/blob/4.9.3/runtime/Cpp/cmake/FindANTLR.cmake
# It has some minimal changes to make it work with the version of antlr downloaded in the main CMakeLists.txt

if (NOT DEFINED ANTLR_FIND_VERSION)
    set (ANTLR_FIND_VERSION "4.10.1" CACHE STRING "Requested version of ANTLR")
endif()

if(NOT ANTLR_EXECUTABLE)
  find_program(ANTLR_EXECUTABLE
               NAMES "antlr-${ANTLR_FIND_VERSION}-complete.jar" antlr4 antlr.jar antlr4.jar antlr-4.jar antlr4)
endif()

if (ANTLR_EXECUTABLE MATCHES ".*\.jar")
  find_package(Java QUIET COMPONENTS Runtime)
  if (Java_JAVA_EXECUTABLE)
    set(ANTLR_COMMAND "${Java_JAVA_EXECUTABLE}" -jar "${ANTLR_EXECUTABLE}" CACHE INTERNAL "Command to run antlr4")
  endif()
elseif(ANTLR_EXECUTABLE)
  set(ANTLR_COMMAND "${ANTLR_EXECUTABLE}" CACHE INTERNAL "Command to run antlr4")
endif()
...
find_package_handle_standard_args(
    ANTLR
    REQUIRED_VARS ANTLR_EXECUTABLE ANTLR_COMMAND
