...
// private, use fromJson() instead!
using rapidjson::Document::Parse;
...
public:
    ...
    static std::string_view valueAsRaw(const rapidjson::Value& value);
    ...
    */
    ...
    void removeEntry(rapidjson::Value& object, const rapidjson::Pointer& pointerToEntry);
    ...
    [[nodiscard]] static rapidjson::Value* findMemberInArray(
        rapidjson::Value* array,
        const rapidjson::Pointer& searchKey,
        const std::string_view& searchValue);

    [[nodiscard]] const static rapidjson::Value* findMemberInArray(
    ...
    static void removeEmptyObjectsAndArrays(rapidjson::Value& value);
