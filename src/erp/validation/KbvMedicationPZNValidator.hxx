...
private:
    ...
    void amountNumerator_erp_begrenzungValue(const model::KbvMedicationPzn& kbvMedicationIngredient) const;
    void amountNumerator_erp_codeUndSystem(const model::KbvMedicationPzn& kbvMedicationIngredient) const;
};
