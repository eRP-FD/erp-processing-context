...
{
    if ("1.1" == versionString)
        return AbgabedatenPkv::v1_1_0;
...
AllProfileVersion profileVersionFromBundle(FhirProfileBundleVersion bundleVersion)
{
    static const std::unordered_map<FhirProfileBundleVersion, AllProfileVersion> mapping{
        ...
        {FhirProfileBundleVersion::v_2023_07_01,
         ...
         AbgabedatenPkv::v1_1_0, Fhir::v4_0_1}}};
...
std::string versionizeProfile(std::string_view profile)
{
    ...
    auto profileVersion = std::get<AnyProfileVersion>(profileVersionFromName(profileName));
