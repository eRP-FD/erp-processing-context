...
{
public:
    MedicationDispenseHandlerBase(Operation operation,
...
private:
    ...
    static model::MedicationsAndDispenses
    medicationDispensesFromParameters(const model::MedicationDispenseOperationParameters& parameters,
                                      model::PrescriptionType workflow);
};
