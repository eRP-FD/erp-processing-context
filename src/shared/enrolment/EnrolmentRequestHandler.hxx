...
using EnrolmentSession = BaseSessionContext;
...
public:
    ...
    using Type = EnrolmentRequestHandlerBasicAuthentication;
...
class EnrolmentRequestHandlerBase
    : public EnrolmentRequestHandlerBasicAuthentication
...
class PostVauAut : public PostBlobHandler
{
public:
    PostVauAut();
...
class DeleteVauAut : public DeleteBlobHandler
{
public:
    DeleteVauAut();
};
