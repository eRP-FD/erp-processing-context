...
public:
    ...
    /**
     * Sign a payload using the VAUAUT key
     *
     * @returns The bp256r1 signature data (R || S)
     */
    ErpVector signWithVauAutKey(const ErpVector& rawPayload);
    ...
    /**
     * Get the VAU AUT Public Key
     *
     * @return ErpVector the public key in binary ANSI X9.62/RFC-5480 format
     */
    shared_EVP_PKEY getVauAutPublicKey();
    ...
    [[nodiscard]] Certificate getVauAutCertificate() const;
