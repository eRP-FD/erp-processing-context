...
{
public:
    static const rapidjson::Pointer valuePeriodStartPointer;
    static const rapidjson::Pointer valuePeriodEndPointer;
};

template<typename ExtensionT>
 // NOLINTNEXTLINE(bugprone-exception-escape)
class Extension : public model::Resource<ExtensionT> , public ExtensionBase
{
public:
