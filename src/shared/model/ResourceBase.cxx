...
rapidjson::Value& ResourceBase::createArray(const rapidjson::Pointer& pointerToArray)
{
    return createArray(mJsonDocument, pointerToArray);
}

rapidjson::Value& ResourceBase::createArray(rapidjson::Value& parent, const rapidjson::Pointer& pointerToArray)
{
    return pointerToArray.Create(parent, mJsonDocument.GetAllocator()).SetArray();
}
...
{
    mJsonDocument.removeFromArray(pointerToArray, index);
}

void ResourceBase::clearArray(const rj::Pointer& pointerToArray)
{
    mJsonDocument.clearArray(pointerToArray);
}

void ResourceBase::removeEmptyObjectsAndArrays()
{
    mJsonDocument.removeEmptyObjectsAndArrays();
}
