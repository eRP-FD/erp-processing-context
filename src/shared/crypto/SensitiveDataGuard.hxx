...
public:
    ...
    explicit SensitiveDataGuard(const SafeString& safeString);
    ...
    SafeString getSafeString() const;
...
inline SensitiveDataGuard::SensitiveDataGuard(const SafeString& safeString)
    : SensitiveDataGuard(safeString.c_str(), safeString.size())
{
}
...
inline SafeString SensitiveDataGuard::getSafeString() const
{
    return SafeString{binaryBufferToString(mSensitiveData)};
}
