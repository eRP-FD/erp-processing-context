...
{
    return (String::toLower(mProtocol) == UrlHelper::HTTPS_PROTOCOL);
}

bool UrlHelper::UrlParts::isHttpProtocol() const
{
    return (String::toLower(mProtocol) == UrlHelper::HTTP_PROTOCOL);
}
