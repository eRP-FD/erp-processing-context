...
TEST(FhirResourceGroupTest, find)
{
    ...
    {
        // no version provided
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url1", std::nullopt})))
        ...
        testing::Mock::VerifyAndClearExpectations(group.get());
    }
    {
        // matching version provided
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url2", "B"_ver})))
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url_noVer", std::nullopt})))
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>(
                                {"http://erp-test.de/some/url_noVer", fhirtools::FhirVersion::notVersioned})))
            .WillRepeatedly(::testing::Return(std::make_pair(fhirtools::FhirVersion::notVersioned, group)));
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>(
                                {"http://erp-test.de/some/url1", fhirtools::FhirVersion::notVersioned})))
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url3", "B"_ver})))
            .WillRepeatedly(::testing::Return(std::make_pair(std::nullopt, nullptr)));
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url/unknown", std::nullopt})))
            .WillRepeatedly(::testing::Return(std::make_pair(std::nullopt, nullptr)));
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url/unknown", "A"_ver})))
            .WillRepeatedly(::testing::Return(std::make_pair(std::nullopt, nullptr)));
    ...
    }
    {
        ...
        EXPECT_CALL(*group, findVersion(Eq<fhirtools::DefinitionKey>({"http://erp-test.de/some/url1|A", std::nullopt})))
            .WillRepeatedly(::testing::Return(std::make_pair(std::nullopt, nullptr)));
