...
{
    const db_model::AccessTokenIdentity accessTokenId(model::TelematikId("0123456789"), "Institutions- oder Organisations-Bezeichnung", "1.2.276.0.76.4.30");
...
{
    const auto accessTokenId = db_model::AccessTokenIdentity::fromJson(R"({"id": "0123456789", "name": "Institutions- oder Organisations-Bezeichnung", "oid": "1.2.276.0.76.4.30"})");
    EXPECT_EQ(accessTokenId.getId(), std::string("0123456789"));
    EXPECT_EQ(accessTokenId.getName(), std::string("Institutions- oder Organisations-Bezeichnung"));
    EXPECT_EQ(accessTokenId.getOid(), std::string("1.2.276.0.76.4.30"));
}
