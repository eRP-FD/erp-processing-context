...
{
    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), expectedDateTime);
        EXPECT_EQ(period.end().toChronoTimePoint(), expectedDateTime + 1s);
    }
...
{
    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{ January / 1 / 1970 });
        EXPECT_EQ(period.end().toChronoTimePoint(), sys_days{ January / 2 / 1970 });
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{ January / 2 / 1970 });
        EXPECT_EQ(period.end().toChronoTimePoint(), sys_days{ January / 3 / 1970 });
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{August/21/2022});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{August/22/2022});
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{December/31/2022});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{January/01/2023});
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{August/31/2022});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{September/01/2022});
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{February/28/2020});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{February/29/2020});
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{February/28/2021});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{March/01/2021});
    }
}
...
{
    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{August/01/2022});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{September/01/2022});
    }

    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{December/01/2022});
        EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{January/01/2023});
    }
}
...
TEST_F(TimePeriodTest, fromFhirSearchDate_successForYear)
{
    ...
    EXPECT_EQ(period.begin().toChronoTimePoint(), sys_days{January/01/2022});
    EXPECT_EQ(period.end().toChronoTimePoint(),   sys_days{January/01/2023});
}
...
TEST_F(TimePeriodTest, fromFhirSearchDate_optionalTimeZone)
{
    ...
    }
    {
        ...
        EXPECT_EQ(period.begin().toChronoTimePoint(), expectedDateTime);
        EXPECT_EQ(period.end().toChronoTimePoint(), expectedDateTime + 1min);
