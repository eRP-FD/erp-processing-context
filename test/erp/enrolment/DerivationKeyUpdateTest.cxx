...
TEST_F(DerivationKeyUpdateTest, Delete2022)//NOLINT(readability-function-cognitive-complexity)
{
...
TEST_F(DerivationKeyUpdateTest, NoDeleteInUse2022)//NOLINT(readability-function-cognitive-complexity)
{
    if (!model::ResourceVersion::deprecatedProfile(
            model::ResourceVersion::current<model::ResourceVersion::DeGematikErezeptWorkflowR4>()))
    {
...
TEST_F(DerivationKeyUpdateTest, DeleteOldUnused2022)//NOLINT(readability-function-cognitive-complexity)
{
    if (!model::ResourceVersion::deprecatedProfile(
            model::ResourceVersion::current<model::ResourceVersion::DeGematikErezeptWorkflowR4>()))
    {
...
TEST_F(DerivationKeyUpdateTest, DeleteMultiple2022)//NOLINT(readability-function-cognitive-complexity)
{
    if (!model::ResourceVersion::deprecatedProfile(
            model::ResourceVersion::current<model::ResourceVersion::DeGematikErezeptWorkflowR4>()))
    {
...
TEST_P(DerivationKeyUpdateTest, TaskWorkflows2022)//NOLINT(readability-function-cognitive-complexity)
{
    if (!model::ResourceVersion::deprecatedProfile(
            model::ResourceVersion::current<model::ResourceVersion::DeGematikErezeptWorkflowR4>()))
    {
...
A set includes one of each
 ...
 - charge item derivation key
    ...
    ::std::array fullWorkflowActions = {&TestTask::create, &TestTask::activate, &TestTask::accept, &TestTask::reject,
                                        &TestTask::accept, &TestTask::close};
