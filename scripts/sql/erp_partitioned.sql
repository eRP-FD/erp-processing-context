...
CREATE TABLE erp.task000005000000 PARTITION OF erp.task FOR VALUES FROM (0) TO (5000000);
CREATE TABLE erp.task000010000000 PARTITION OF erp.task FOR VALUES FROM (5000000) TO (10000000);
CREATE TABLE erp.task000015000000 PARTITION OF erp.task FOR VALUES FROM (10000000) TO (15000000);
CREATE TABLE erp.task000020000000 PARTITION OF erp.task FOR VALUES FROM (15000000) TO (20000000);
CREATE TABLE erp.task000025000000 PARTITION OF erp.task FOR VALUES FROM (20000000) TO (25000000);
CREATE TABLE erp.task000030000000 PARTITION OF erp.task FOR VALUES FROM (25000000) TO (30000000);
CREATE TABLE erp.task000035000000 PARTITION OF erp.task FOR VALUES FROM (30000000) TO (35000000);
CREATE TABLE erp.task000040000000 PARTITION OF erp.task FOR VALUES FROM (35000000) TO (40000000);
CREATE TABLE erp.task000045000000 PARTITION OF erp.task FOR VALUES FROM (40000000) TO (45000000);
CREATE TABLE erp.task000050000000 PARTITION OF erp.task FOR VALUES FROM (45000000) TO (50000000);
CREATE TABLE erp.task000055000000 PARTITION OF erp.task FOR VALUES FROM (50000000) TO (55000000);
CREATE TABLE erp.task000060000000 PARTITION OF erp.task FOR VALUES FROM (55000000) TO (60000000);
CREATE TABLE erp.task000065000000 PARTITION OF erp.task FOR VALUES FROM (60000000) TO (65000000);
CREATE TABLE erp.task000070000000 PARTITION OF erp.task FOR VALUES FROM (65000000) TO (70000000);
CREATE TABLE erp.task000075000000 PARTITION OF erp.task FOR VALUES FROM (70000000) TO (75000000);
CREATE TABLE erp.task000080000000 PARTITION OF erp.task FOR VALUES FROM (75000000) TO (80000000);
CREATE TABLE erp.task000085000000 PARTITION OF erp.task FOR VALUES FROM (80000000) TO (85000000);
CREATE TABLE erp.task000090000000 PARTITION OF erp.task FOR VALUES FROM (85000000) TO (90000000);
CREATE TABLE erp.task000095000000 PARTITION OF erp.task FOR VALUES FROM (90000000) TO (95000000);
CREATE TABLE erp.task000100000000 PARTITION OF erp.task FOR VALUES FROM (95000000) TO (100000000);
CREATE TABLE erp.task000105000000 PARTITION OF erp.task FOR VALUES FROM (100000000) TO (105000000);
CREATE TABLE erp.task000110000000 PARTITION OF erp.task FOR VALUES FROM (105000000) TO (110000000);
CREATE TABLE erp.task000115000000 PARTITION OF erp.task FOR VALUES FROM (110000000) TO (115000000);
CREATE TABLE erp.task000120000000 PARTITION OF erp.task FOR VALUES FROM (115000000) TO (120000000);
CREATE TABLE erp.task000125000000 PARTITION OF erp.task FOR VALUES FROM (120000000) TO (125000000);
CREATE TABLE erp.task000130000000 PARTITION OF erp.task FOR VALUES FROM (125000000) TO (130000000);
CREATE TABLE erp.task000135000000 PARTITION OF erp.task FOR VALUES FROM (130000000) TO (135000000);
CREATE TABLE erp.task000140000000 PARTITION OF erp.task FOR VALUES FROM (135000000) TO (140000000);
CREATE TABLE erp.task000145000000 PARTITION OF erp.task FOR VALUES FROM (140000000) TO (145000000);
CREATE TABLE erp.task000150000000 PARTITION OF erp.task FOR VALUES FROM (145000000) TO (150000000);
CREATE TABLE erp.task000155000000 PARTITION OF erp.task FOR VALUES FROM (150000000) TO (155000000);
CREATE TABLE erp.task000160000000 PARTITION OF erp.task FOR VALUES FROM (155000000) TO (160000000);
CREATE TABLE erp.task000165000000 PARTITION OF erp.task FOR VALUES FROM (160000000) TO (165000000);
CREATE TABLE erp.task000170000000 PARTITION OF erp.task FOR VALUES FROM (165000000) TO (170000000);
CREATE TABLE erp.task000175000000 PARTITION OF erp.task FOR VALUES FROM (170000000) TO (175000000);
CREATE TABLE erp.task000180000000 PARTITION OF erp.task FOR VALUES FROM (175000000) TO (180000000);
CREATE TABLE erp.task000185000000 PARTITION OF erp.task FOR VALUES FROM (180000000) TO (185000000);
CREATE TABLE erp.task000190000000 PARTITION OF erp.task FOR VALUES FROM (185000000) TO (190000000);
CREATE TABLE erp.task000195000000 PARTITION OF erp.task FOR VALUES FROM (190000000) TO (195000000);
CREATE TABLE erp.task000200000000 PARTITION OF erp.task FOR VALUES FROM (195000000) TO (200000000);
CREATE TABLE erp.task000205000000 PARTITION OF erp.task FOR VALUES FROM (200000000) TO (205000000);
CREATE TABLE erp.task000210000000 PARTITION OF erp.task FOR VALUES FROM (205000000) TO (210000000);
CREATE TABLE erp.task000215000000 PARTITION OF erp.task FOR VALUES FROM (210000000) TO (215000000);
CREATE TABLE erp.task000220000000 PARTITION OF erp.task FOR VALUES FROM (215000000) TO (220000000);
CREATE TABLE erp.task000225000000 PARTITION OF erp.task FOR VALUES FROM (220000000) TO (225000000);
CREATE TABLE erp.task000230000000 PARTITION OF erp.task FOR VALUES FROM (225000000) TO (230000000);
CREATE TABLE erp.task000235000000 PARTITION OF erp.task FOR VALUES FROM (230000000) TO (235000000);
CREATE TABLE erp.task000240000000 PARTITION OF erp.task FOR VALUES FROM (235000000) TO (240000000);
CREATE TABLE erp.task000245000000 PARTITION OF erp.task FOR VALUES FROM (240000000) TO (245000000);
CREATE TABLE erp.task000250000000 PARTITION OF erp.task FOR VALUES FROM (245000000) TO (250000000);
CREATE TABLE erp.task000255000000 PARTITION OF erp.task FOR VALUES FROM (250000000) TO (255000000);
CREATE TABLE erp.task000260000000 PARTITION OF erp.task FOR VALUES FROM (255000000) TO (260000000);
CREATE TABLE erp.task000265000000 PARTITION OF erp.task FOR VALUES FROM (260000000) TO (265000000);
CREATE TABLE erp.task000270000000 PARTITION OF erp.task FOR VALUES FROM (265000000) TO (270000000);
CREATE TABLE erp.task000275000000 PARTITION OF erp.task FOR VALUES FROM (270000000) TO (275000000);
CREATE TABLE erp.task000280000000 PARTITION OF erp.task FOR VALUES FROM (275000000) TO (280000000);
CREATE TABLE erp.task000285000000 PARTITION OF erp.task FOR VALUES FROM (280000000) TO (285000000);
CREATE TABLE erp.task000290000000 PARTITION OF erp.task FOR VALUES FROM (285000000) TO (290000000);
CREATE TABLE erp.task000295000000 PARTITION OF erp.task FOR VALUES FROM (290000000) TO (295000000);
CREATE TABLE erp.task000300000000 PARTITION OF erp.task FOR VALUES FROM (295000000) TO (300000000);
--
